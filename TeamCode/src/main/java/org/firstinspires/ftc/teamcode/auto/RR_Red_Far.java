...
@Config
@Autonomous(name="RR_Red_Far",group = "Auto")
public class RR_Red_Far extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory traj1R = drive.trajectoryBuilder(Red_far_pose, true)
                .splineTo(new Vector2d(-32, -36), Math.toRadians(5)) //-36,-12
