...
//    Scalar highBlueHSV = new Scalar(130, 255, 255);
    ...
    Scalar lower_red1 = new Scalar(0,40,40);
    Scalar upper_red1 = new Scalar(20,255,255);
    Scalar lower_red2 = new Scalar(300,50,50);
    Scalar upper_red2 = new Scalar(360,255,255);
